...
def train_and_eval(colab: bool, batch_size: int, done_epochs: int, train_epochs: int, clear_log: bool = False) -> None:
    ...
    dataset_val=UCFCrimeDataset(location['video_path'],location['annotation_path'],transform=transform,clip_length_in_frames=16)
    ...
    model = LSTM_with_EFFICIENTNET(num_classes=14,hidden_size=16,num_layers=2,pretrained=True,fine_tune=False).to(device)
